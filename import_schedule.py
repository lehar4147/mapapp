        ...
        if (len(temp_list) > 0):
            ...
            if (data != '[]'):
                ...
                if (temp_list[0] == "Commons Dining Hall"):
                    ...
                    for i in range(0, 7):
                      building_hours.append((dotw[i], opentime, closetime))                
                building_list.append(building.Building(temp_list[0], '', float(cordinfo['lon']), float(cordinfo['lat']), '', building_hours, buildaccess))
    building_list.append(building.Building("'87 Gymnasium", '', -73.67881, 42.7308, '', building_hours, ''))
    building_list.append(building.Building("Blitman Dining Hall", '', -73.68581, 42.73151, '', building_hours, ''))
    building_list.append(building.Building("EMPAC Theater", '', -73.68364, 42.72888, '', building_hours, ''))
    building_list.append(building.Building("J Erik Jonsson Engineering Center", '', -73.68016, 42.72968, '', building_hours, ''))
    building_list.append(building.Building("Center for Biotechnology and Iterdisciplinary Studies", '', -73.67863, 42.72832, '', building_hours, ''))
    building_list.append(building.Building("Walker Laboratory", '', -73.68259, 42.73082, '', building_hours, ''))
    building_list.append(building.Building("Russel Sage Laboratory", '', -73.68164, 42.73086, '', building_hours, ''))
    building_list.append(building.Building("Hirsch Observatory", '', -73.68051, 42.72842, '', building_hours, ''))
    building_list.append(building.Building("Jonsson-Rowland Science Center (J-ROWL)", '', -73.68057, 42.72889, '', building_hours, ''))
    building_list.append(building.Building("Voorhees Computing Center", '', -73.68179, 42.72923, '', building_hours, ''))
    building_list.append(building.Building("Chapel + Cultural Center", '', -73.67226, 42.73177, '', building_hours, ''))
    building_list.append(building.Building("Carnegie Building", '', -73.68322, 42.73043, '', building_hours, ''))
    building_list.append(building.Building("East Campus Athlietic Village", '', -73.66761, 42.73231, '', building_hours, ''))
    building_list.append(building.Building("Houston Field House", '', -73.66959, 42.73213, '', building_hours, ''))
    building_list.append(building.Building("Admissions", '', -73.67547, 42.73067, '', building_hours, ''))
    building_list.append(building.Building("RPI Public Safety", '', -73.67714, 42.72926, '', building_hours, ''))
